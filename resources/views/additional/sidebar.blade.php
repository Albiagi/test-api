<div class="d-flex flex-column p-3 border-end" style="width: 280px; min-height: 100vh;">
    <a href="{{ url('dashboard') }}" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item mt-5">
            <a href="{{ url('dashboard') }}" class="nav-link  {{ ($ht === "Dashboard") ? 'active' : '' }}">
        ...
        <li class="mt-2">
            <a href="{{ url('master') }}" class="nav-link {{ ($ht === "Master Pengguna") ? 'active' : '' }}">
